...
/// <summary>
/// In-process replacement for the pp-security-role-privilege template post-action
/// scripts, with the tools-devkit-templates#152 semantics: the spec accepts quoted
/// or bare JSON and the "type" key alias, UI level names map onto the role XSD
/// values (User=Basic, BusinessUnit=Local, ParentChild=Deep), level None omits the
/// privilege, and unknown types/levels fail naming the valid values. Privileges
/// merge into the role file idempotently, sorted alphabetically by name.
/// </summary>
