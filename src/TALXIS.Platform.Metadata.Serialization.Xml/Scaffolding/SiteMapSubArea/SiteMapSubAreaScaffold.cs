...
/// <summary>
/// In-process replacement for the pp-sitemap-subarea template post-action script:
/// builds the SubArea element for the requested page type (same seven branches and
/// markup as the old script, generated short id included) and appends it to the
/// target group of the app's sitemap.
/// </summary>
