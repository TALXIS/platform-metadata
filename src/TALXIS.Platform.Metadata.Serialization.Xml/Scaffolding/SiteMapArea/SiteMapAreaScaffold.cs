...
/// <summary>
/// In-process replacement for the pp-sitemap-area template post-action scripts:
/// stamps a generated short id into the rendered area payload and appends it to
/// the app's SiteMap element.
/// </summary>
