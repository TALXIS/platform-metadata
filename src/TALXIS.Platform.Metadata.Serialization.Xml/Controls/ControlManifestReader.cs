...
public static class ControlManifestReader
{
    ...
    private sealed class ArchiveSearchResult
    {
        ...
        /// <summary>
        /// The archive entry path the manifest was found at (e.g. Controls/talxis_TALXIS.PCF.Grid/ControlManifest.xml).
        /// </summary>
        public string? ManifestEntryPath { get; set; }
        /// <summary>
        /// CustomControl names declared in customizations.xml of the same solution archive.
        /// </summary>
